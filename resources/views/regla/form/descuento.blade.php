...
<div class="col-md-12">
  <div class="panel panel-border-color panel-border-color-warning">
    ...
    <div class="panel-body">
		...
		<div class="col-sm-6 ind_condicionpago">
			<div class="form-group">

			  	<label class="col-sm-4 control-label">
			  		<div class="tooltipfr"> Condicion de pago
			  			<span class="tooltiptext">Fijar una condicion de pago para que el descuento aplique.</span>
					</div>
				</label>
				
				<div class="col-sm-8 ">
			          {!! Form::select( 'condicionpago', $combocondicionpago, array(),
                      [
                        'class'       => 'form-control control select2' ,
                        'id'          => 'condicionpago',
                        'data-aw'     => '1',
		...
		<div class="col-sm-6 ind_cantidad_minima">
			<div class="form-group">
			  	<label class="col-sm-4 control-label">
			  		<div class="tooltipfr">Cantidad Máxima <span class='requerido'>*</span>
					  <span class="tooltiptext">Cantidad que puede  comprar como máximo para aplicación de la regla
					  							(si es 0 aplica en cualquier cantidad comprada).</span>
					</div>
			  	</label>
			  	<div class="col-sm-8 abajocaja">
			    ...
			    <input  type="text"
			            ...
			            value="@if(isset($regla)){{old('cantidadmaxima' ,$regla->cantidadmaxima)}}@else{{old('cantidadmaxima',0)}}@endif"
			            placeholder="Cantidad Máxima"
			            required = "" class="form-control input-sm solonumero" data-parsley-type="number"
			            autocomplete="off" data-aw="6"/>

			    @include('error.erroresvalidate', [ 'id' => $errors->has('cantidadmaxima')  , 
			                                          'error' => $errors->first('cantidadmaxima', ':message') , 
			                                          'data' => '6'])
